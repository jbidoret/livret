...
let controls = `<nav class="tools">
  <button class="button-capture" style="display:none"><span>Capture</span></button>
...
let modal = `<div class="modal">
  <p>Outil de conception d’un livret recto-verso</p>
  <p>Pour dessiner dans les pages, cliquer sur la page, puis activer la capture via la webcam</p>
  <p>Le bouton [1-8] permet de réaliser l’imposition</p>
